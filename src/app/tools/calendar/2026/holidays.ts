...
export const HOLIDAYS: Holiday[] = [
  /* ── BSD 405 Official Calendar (2025-2026) ── */
  { date: '2026-01-01', name: 'BSD Offices Closed',         color: 'yellow', type: 'bsd' },
  { date: '2026-01-02', name: 'BSD Offices Closed',         color: 'yellow', type: 'bsd' },
  { date: '2026-01-19', name: 'BSD No School (MLK Day)',     color: 'yellow', type: 'bsd' },
  { date: '2026-01-23', name: 'BSD End of 1st Semester',     color: 'yellow', type: 'bsd' },
  { date: '2026-01-26', name: 'BSD No School',               color: 'yellow', type: 'bsd' },
  { date: '2026-02-16', name: 'BSD Mid-Winter Break',        color: 'yellow', type: 'bsd' },
  ...
  { date: '2026-05-25', name: 'BSD No School (Memorial)',    color: 'yellow', type: 'bsd' },
  { date: '2026-05-26', name: 'BSD Non-School Day',          color: 'yellow', type: 'bsd' },
  { date: '2026-06-19', name: 'BSD Offices Closed',          color: 'yellow', type: 'bsd' },

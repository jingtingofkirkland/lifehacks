...
export default function MathAdditionPage() {
  ...
  useEffect(() => {
    ...
    styleEl.setAttribute('data-math-tool', 'addition');
  ...
  return (
    <article className="min-h-screen bg-gradient-to-b from-emerald-50 via-background to-background dark:from-emerald-950/20 dark:via-background dark:to-background">
